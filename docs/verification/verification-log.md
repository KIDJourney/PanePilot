...
| 日期 | 场景 | 变更 | 验证 | 结果 |
|---|---|---|---|---|
| 2026-08-14 | 代码变更强制正式发布 | 新增 post-commit 自动 patch Release 和 pre-push 远端 Release 门禁；修正“只有明确要求才发布”的项目规则 | dry-run、未发布 commit 拦截、正式 `v0.1.6` 本地签名/公证/上传/下载校验/启动验证 | 待本轮正式发布完成后更新 |
