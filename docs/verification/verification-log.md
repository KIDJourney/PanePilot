...
| 日期 | 场景 | 变更 | 验证 | 结果 |
|---|---|---|---|---|
| 2026-08-14 | 英文与简体中文 | 菜单、设置、动作、登录项状态、权限和更新提示改为标准 App bundle 本地化，默认跟随 macOS；增加资源和代表性文案门禁 | `swift test`、`make verify-localizations`、中英文默认/最小尺寸设置截图、`make local-check`、正式 Release | 待本轮验证和自动发布完成后更新 |
